class CantonAT340snapshot202507100 < Formula
  desc "Blockchain protocol implementation from Digital Asset (v3.4.0-snapshot.20250710.0)"
  ...
  def caveats
    ...
    <<~EOS
      Canton 3.4.0-snapshot.20250707.16366.0.vf80131e0 (#{release_type}) has been installed.
