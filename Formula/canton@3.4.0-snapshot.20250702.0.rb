class CantonAT340snapshot202507020 < Formula
  desc "Blockchain protocol implementation from Digital Asset (v3.4.0-snapshot.20250702.0)"
  ...
  def caveats
    ...
    <<~EOS
      Canton 3.4.0-snapshot.20250624.16258.0.v3144db49 (#{release_type}) has been installed.
      DAML Release: v3.4.0-snapshot.20250702.0
