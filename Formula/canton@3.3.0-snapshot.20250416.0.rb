...
class CantonAT330Snapshot202504160 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.3.0-snapshot.20250416.0)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.3.0-snapshot.20250416.0/canton-open-source-3.3.0-snapshot.20250412.15740.0.vd4a48308.tar.gz"
  sha256 "978a8929dd18ea09f3662415c89aff779a295b8427838a601a71112567cc834e"
  version "3.3.0-snapshot.20250416.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      Canton Version: 3.3.0-snapshot.20250412.15740.0.vd4a48308
      DAML Tag: v3.3.0-snapshot.20250416.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      Canton 3.3.0-snapshot.20250412.15740.0.vd4a48308 (pre-release) has been installed.
      DAML Release Tag: v3.3.0-snapshot.20250416.0
