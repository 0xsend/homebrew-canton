class CantonAT340snapshot202507230 < Formula
  desc "Blockchain protocol implementation from Digital Asset (v3.4.0-snapshot.20250723.0)"
  ...
  def caveats
    ...
    <<~EOS
      Canton 3.4.0-snapshot.20250715.16432.0.vcd4fe703 (#{release_type}) has been installed.
      DAML Release: v3.4.0-snapshot.20250723.0
