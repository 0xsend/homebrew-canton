...
class CantonAT340Snapshot202510020 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.4.0-snapshot.20251002.0)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.4.0-snapshot.20251002.0/canton-open-source-3.4.0-snapshot.20250922.16951.0.v1eb3f268.tar.gz"
  sha256 "e0f59a7b5015b56479ef4786662c5935a0fee9ac803465bb0f70bdc6c3bf4dff"
  version "3.4.0-snapshot.20251002.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      ...
      DAML Tag: v3.4.0-snapshot.20251002.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      ...
      DAML Release Tag: v3.4.0-snapshot.20251002.0
