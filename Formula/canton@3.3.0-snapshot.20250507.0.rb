...
class CantonAT330Snapshot202505070 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.3.0-snapshot.20250507.0)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.3.0-snapshot.20250507.0/canton-open-source-3.3.0-snapshot.20250507.15804.0.v15a8b550.tar.gz"
  sha256 "88b646609816b457f9707ff9bf12b1fa0d35e01978212238116d707e749d31f8"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      Canton Version: 3.3.0-snapshot.20250507.15804.0.v15a8b550
      DAML Tag: v3.3.0-snapshot.20250507.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      Canton 3.3.0-snapshot.20250507.15804.0.v15a8b550 (pre-release) has been installed.
      DAML Release Tag: v3.3.0-snapshot.20250507.0
