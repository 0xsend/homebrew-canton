...
class CantonAT3411 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.4.11)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.4.11/canton-open-source-3.4.11.tar.gz"
  sha256 "77ed313a738d87bcbd94ca23d9782e79b5365419760986742e352a6e56e38edb"
  version "3.4.11"
  license "Apache-2.0"
  ...
  def caveats
    <<~EOS
      Canton 3.4.11 (pre-release) has been installed.
      DAML Release Tag: v3.4.11
