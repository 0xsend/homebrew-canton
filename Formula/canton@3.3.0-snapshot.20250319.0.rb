...
class CantonAT330Snapshot202503190 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.3.0-snapshot.20250319.0)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.3.0-snapshot.20250319.0/canton-open-source-3.3.0-snapshot.20250314.15478.0.ve9d27a7b.tar.gz"
  sha256 "25ed7c1d3b1a6d2f73d051febe90a51f5971d7d27cbaace8098b37c177a0091d"
  version "3.3.0-snapshot.20250319.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      Canton Version: 3.3.0-snapshot.20250314.15478.0.ve9d27a7b
      DAML Tag: v3.3.0-snapshot.20250319.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      Canton 3.3.0-snapshot.20250314.15478.0.ve9d27a7b (pre-release) has been installed.
      DAML Release Tag: v3.3.0-snapshot.20250319.0
