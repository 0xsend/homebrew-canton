...
class CantonAT340Snapshot202507090 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.4.0-snapshot.20250709.0)"
  ...
  version "3.4.0-snapshot.20250709.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      ...
      DAML Tag: v3.4.0-snapshot.20250709.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      ...
      DAML Release Tag: v3.4.0-snapshot.20250709.0
