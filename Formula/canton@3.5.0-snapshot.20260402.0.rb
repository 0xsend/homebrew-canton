...
class CantonAT350Snapshot202604020 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.5.0-snapshot.20260402.0)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.5.0-snapshot.20260402.0/canton-open-source-3.5.0-snapshot.20260331.18514.0.v0aa87074.tar.gz"
  sha256 "79961b043e14879fc77b489586ad0671e5572c7860f1f974e13d46bd6ed6af74"
  version "3.5.0-snapshot.20260402.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      ...
      DAML Tag: v3.5.0-snapshot.20260402.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      ...
      DAML Release Tag: v3.5.0-snapshot.20260402.0
