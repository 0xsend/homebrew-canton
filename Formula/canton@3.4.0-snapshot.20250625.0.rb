...
class CantonAT340Snapshot202506250 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.4.0-snapshot.20250625.0)"
  ...
  version "3.4.0-snapshot.20250625.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      ...
      DAML Tag: v3.4.0-snapshot.20250625.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      Canton 3.4.0-snapshot.20250617.16217.0.vbdf62919 (pre-release) has been installed.
      DAML Release Tag: v3.4.0-snapshot.20250625.0
