...
class CantonAT340Snapshot202506040 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.4.0-snapshot.20250604.0)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.4.0-snapshot.20250604.0/canton-open-source-3.4.0-snapshot.20250520.15991.0.v507dc122.tar.gz"
  sha256 "0a679d7659b385c17fb8475ed755de648e02b5754f2bbf2f86f9973d76a8d72c"
  version "3.4.0-snapshot.20250604.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      ...
      DAML Tag: v3.4.0-snapshot.20250604.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      ...
      DAML Release Tag: v3.4.0-snapshot.20250604.0
