...
class CantonAT350Snapshot202602050 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.5.0-snapshot.20260205.0)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.5.0-snapshot.20260205.0/canton-open-source-3.5.0-snapshot.20260203.17930.0.v8a849517.tar.gz"
  sha256 "8bf07743362ac85034d7e456cf0202e70c00606fee44ae75999fc6d55ab9d50b"
  version "3.5.0-snapshot.20260205.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      Canton Version: 3.5.0-snapshot.20260203.17930.0.v8a849517
      DAML Tag: v3.5.0-snapshot.20260205.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      Canton 3.5.0-snapshot.20260203.17930.0.v8a849517 (pre-release) has been installed.
      DAML Release Tag: v3.5.0-snapshot.20260205.0
