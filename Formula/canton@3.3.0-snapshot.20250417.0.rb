...
class CantonAT330Snapshot202504170 < Formula
  desc "Blockchain protocol implementation from Digital Asset (version 3.3.0-snapshot.20250417.0)"
  homepage "https://www.canton.network/"

  url "https://github.com/digital-asset/daml/releases/download/v3.3.0-snapshot.20250417.0/canton-open-source-3.3.0-snapshot.20250416.15779.0.v6cccc0c4.tar.gz"
  sha256 "7bead0601b16dc5d4f618bd7fd75ee5256bd42219baa1230b60c5e3b12384410"
  version "3.3.0-snapshot.20250417.0"
  license "Apache-2.0"
  ...
  def install
    ...
    (prefix/"VERSION_INFO.txt").write <<~EOS
      Canton Version: 3.3.0-snapshot.20250416.15779.0.v6cccc0c4
      DAML Tag: v3.3.0-snapshot.20250417.0
      Pre-release: Yes
      Installed: #{Time.now}
    EOS
  end
  ...
  def caveats
    <<~EOS
      Canton 3.3.0-snapshot.20250416.15779.0.v6cccc0c4 (pre-release) has been installed.
      DAML Release Tag: v3.3.0-snapshot.20250417.0
